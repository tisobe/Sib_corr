...
sub plot_comb{
	...
	pgclos();
	system("echo ''|gs -sDEVICE=ppmraw  -r256x256 -q -NOPAUSE -sOutputFile=-  ./Temp_data/pgplot.ps|$bin_dir/pnmcrop | $bin_dir/pnmflip -r270 | $bin_dir/ppmtogif > $web_dir/Plots/comb_plot.gif");
