...
#	three_sigma_fit();		#--- select data point in 3 sigma deviation and fit a line
	...
	system("echo ''|gs -sDEVICE=ppmraw  -r256x256 -q -NOPAUSE -sOutputFile=-  ./Temp_data/pgplot.ps|$bin_dir/pnmcrop | $bin_dir/pnmflip -r270 |$bin_dir/ppmtogif > $web_dir/Plots/Plot_long/$name2");
